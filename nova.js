...
function calculaProcessador() {
   total = document.getElementById("Processadores").value * 1000;
   total2 = parseInt(document.getElementById("custo").innerHTML) + total;
   document.getElementById("custo").innerHTML = total2
}
function calculaMemoria() {
   total = document.getElementById("Memória").value * 10;
   total2 = parseInt(document.getElementById("custo").innerHTML) + total;
   document.getElementById("custo").innerHTML = total2

}
function calculaHD() {
   total = document.getElementById("HD").value * 10;
   total2 = parseInt(document.getElementById("custo").innerHTML) + total;
   document.getElementById("custo").innerHTML = total2

}
function calculaTransferencia() {
   total = document.getElementById("Transferência").value * 15;
   total2 = parseInt(document.getElementById("custo").innerHTML) + total;
   document.getElementById("custo").innerHTML = total2
